  ...
  return (
    <section className="contact section" id="contact" aria-label="Contact">
      <div className="container">
        {/* Headline */}
        <div className="contact__hero reveal">
          ...
          <p className="contact__sub">
            Have an interesting project, opportunity, or idea? Let&apos;s connect.
          </p>
        </div>

        {/* Contact Links Card Box */}
        <div className="contact__card-wrapper reveal">
          <a
            href={`mailto:${profile.email}`}
            className="contact-card"
            aria-label="Send Email to Pranav Kaushik"
          >
            ...
            <ArrowUpRight size={18} className="contact-card__arrow" />
          </a>
          ...
          >
            ...
            <div className="contact-card__info">
              ...
              <span className="contact-card__value">pranav-kaushik</span>
            </div>
            <ArrowUpRight size={18} className="contact-card__arrow" />
          </a>
          ...
          >
            ...
            <div className="contact-card__info">
              ...
              <span className="contact-card__value">Pranav-Kaushik008</span>
            </div>
            <ArrowUpRight size={18} className="contact-card__arrow" />
          </a>
        </div>
